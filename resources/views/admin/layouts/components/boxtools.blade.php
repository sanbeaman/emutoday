    ...
    <div class="btn-toolbar btn-group-sm">
        {{-- <div class="input-group input-group-sm" style="width: 150px;">
            ...
            {{-- @can('super', $cuser) --}}
                ...
                @if($rte == 'story' ||$rte == 'student'||$rte == 'article')
                         @if(isset($id))
                         <a href="/preview/{{$rte}}/{{$id}}" class="btn bg-orange btn-sm"><i class="fa fa-eye"></i></a>
                         @endif
                         <a href="/admin/story/{{$rte}}/setup" class="btn bg-orange btn-sm {{ set_active($path.'/setup', 'disabled') }}"><i class="fa fa-plus-square"></i></a>
                         <a href="/admin/story/{{$rte}}" class="btn bg-orange {{ set_active($path, 'disabled') }}"><i class="fa fa-list-alt"></i></a>
