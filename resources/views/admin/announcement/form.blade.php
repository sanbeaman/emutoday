            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div id="vue-announcements">
                            <announcement-form framework="bootstrap" authorid="{{$currentUser->id}}" recordexists="{{$announcement->exists ? true: false}}" editid="{{$announcement->exists ? $announcement->id : null }}">
