                  ...
                  <div class="large-12 medium-12 small-12 columns">
                    ...
                    <div id="five-events-bar">
                      <div id="news-title-bar" class="row">
                        <div class="large-12 medium-12 hide-for-small columns"><h5 class="subhead-title">Featured Events</h5></div>

                      </div>
                      <div class="row">
                        <div class="large-up-5 medium-up-3 show-for-medium" data-equalizer>
                          <div class="column">
