...
<div class="row">
    <div v-bind:class="md6col">
        <div class="form-group">
            ...
            <input id="start-date" v-bind:class="[formErrors.start_date ? 'invalid-input' : '']" type="text" v-model="newevent.start_date" aria-describedby="errorStartDate" />
    ...
    <div v-bind:class="md6col">
        <div class="form-group">
            ...
            <input id="end-date" v-bind:class="[formErrors.end_date ? 'invalid-input' : '']" type="text" v-model="newevent.end_date"  aria-describedby="errorEndDate" />
    ...
    <div class="row">
        <div v-bind:class="md6col">
            <div v-show="hasStartTime" class="form-group">
                ...
                <input id="start-time" type="text" v-model="newevent.start_time" />
            </div><!-- /.form-group -->
        </div><!-- /.md6col -->
        <div v-bind:class="md6col">
            <div v-show="hasEndTime" class="form-group">
                <label for="end-time">End Time: <i class="fi-star reqstar"></i></label>
                <input id="end-time" type="text" v-model="newevent.end_time" />
            </div><!-- /.form-group -->
        </div><!-- /.md6col -->
    </div><!-- /.row -->
    <div class="row">
