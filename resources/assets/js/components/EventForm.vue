<template>
  <form @submit.prevent="submitForm">
    <div class="row" v-bind:class="[formErrors.title ? 'invalid-input' : '']">
    ...
    <div class="row" v-bind:class="[formErrors.location ? 'invalid-input' : '']">
      <div class="small-12 column">
      <label>Location
        <autocomplete
          id="location"
  ...
  <div class="row">
    <div class="medium-4 columns" v-bind:class="[formErrors.start_date ? 'invalid-input' : '']">
  ...
  <div class="row">
    <div class="medium-4 column" v-bind:class="[formErrors.end_date ? 'invalid-input' : '']">
  ...
  <div class="row" v-bind:class="[formErrors.categories ? 'invalid-input' : '']">
    <div class="small-12 column">
...
<div class="row" v-bind:class="[formErrors.contact_person ? 'invalid-input' : '']">
<div class="small-12 column">
...
<div class="row" v-bind:class="[formErrors.contact_phone? 'invalid-input' : '']">
  <div class="small-12 column">
...
<div class="row" v-bind:class="[formErrors.contact_email? 'invalid-input' : '']">
  <div class="small-12 column">
...
<div class="row" v-bind:class="[formErrors.description ? 'invalid-input' : '']">
    <div class="small-12 column">
