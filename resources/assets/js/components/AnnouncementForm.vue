						...
						<div class="row">
							<div v-bind:class="md12col">
								...
								<div v-bind:class="formGroup">
									...
									<textarea v-model="record.announcement" v-bind:class="[formErrors.announcement ? 'invalid-input' : '']" name="announcement" type="textarea" rows="12"></textarea>
								</label>
					...
					<div class="row">
						<div v-bind:class="md6col">
								<div v-bind:class="formGroup">
									...
									<input id="start-date" class="formControl" v-bind:class="[formErrors.start_date ? 'invalid-input' : '']" type="text" v-model="record.start_date | momentfilter" v-mydatedropper />
						...
						<div v-bind:class="md6col">
								<div v-bind:class="formGroup">
										...
										<template v-if="hasStartDate">
											<input v-bind:class="[formErrors.end_date ? 'invalid-input' : '']" type="text" v-model="record.end_date  | momentfilter"   v-mydatedropper />

										</template>
										<template v-else>
											<input v-bind:class="[formErrors.end_date ? 'invalid-input' : '']" type="text" v-model="record.end_date  | momentfilter"  v-mydatedropper disabled="disabled" />
