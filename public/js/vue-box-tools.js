...
exports.default = {
    components: {},
    props: ['isdirty', 'rte', 'formView', 'currentUser', 'role', 'recordId'],
    ...
    methods: {
        setDirtyValue: function setDirtyValue(value) {
            console.log('setDirtyValue===' + value);
            this.isdirty = value;
        },
...
var vm = new Vue({
    ...
    methods: {
        changeDirtyState: function changeDirtyState(value) {
...
},{"./components/BoxTools.vue":7,"moment":1,"vue":5,"vue-resource":4}]},{},[8]);

//# sourceMappingURL=vue-box-tools.js.map
