...
},{"dragula":8}],12:[function(require,module,exports){
var Vue // late bind
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"dragwrapper\">\n\t<div class=\"row\">\n\t\t<div class=\"col-md-6\">\n\t\t\t<div class=\"dragcontainer\" v-dragula=\"colOne\" bag=\"first-bag\">\n\t\t\t\t<!-- with click -->\n\t\t\t\t<div v-for=\"text in colOne\" @click=\"onClick\">{{text}} [click me]</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"col-md-6\">\n\t\t\t<div class=\"dragcontainer\" v-dragula=\"colTwo\" bag=\"first-bag\">\n\t\t\t\t<div v-for=\"text in colTwo\">{{text}}</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\n\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d25c75d0", module.exports)
  } else {
    hotAPI.update("_v-d25c75d0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":13,"vue-hot-reload-api":12,"vueify/lib/insert-css":14}],16:[function(require,module,exports){
'use strict';
...
new Vue({
		...
		ready: function ready() {
				console.log(this);
				Vue.dragcol.$on('drop', function (args) {
						console.log('drop: ' + args[0]);
						console.log(colOne);
				});
				Vue.dragcol.$on('dropModel', function (args) {
						console.log('dropModel: ' + args[0]);
						console.log(colOne);
				});
		}
...
},{"./components/DragCol.vue":15,"vue":13,"vue-dragula":11}]},{},[16]);
