...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n  <form @submit.prevent=\"submitForm\" _v-0879ddea=\"\">\n    <div class=\"form-group\" v-bind:class=\"[formErrors.title ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n\n        <label _v-0879ddea=\"\">Title\n        <input v-model=\"newevent.title\" name=\"title\" type=\"text\" _v-0879ddea=\"\">\n        <p v-if=\"formErrors.title\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Title!</p>\n      </label>\n\n    </div>\n    <div class=\"form-group\" _v-0879ddea=\"\">\n\n      <label _v-0879ddea=\"\">Short Title\n        <input v-model=\"newevent.short_title\" type=\"text\" placeholder=\"Short Title\" name=\"short-title\" _v-0879ddea=\"\">\n      </label>\n\n    </div>\n    <div class=\"form-group\" v-bind:class=\"[formErrors.location ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n\n      <label _v-0879ddea=\"\">Location\n        <autocomplete id=\"location\" class=\"location\" name=\"locationlist\" placeholder=\"Type Here\" url=\"/api/buildings\" param=\"q\" anchor=\"name\" label=\"alias\" model=\"vModelLike\" _v-0879ddea=\"\">\n        </autocomplete>\n        <p v-if=\"formErrors.location\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Location!</p>\n      </label>\n    </div>\n\n    <div class=\"form-group\" v-bind:class=\"[formErrors.start_date ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n      <label for=\"start-date\" _v-0879ddea=\"\">Start Date:</label>\n      <datepicker id=\"start-date\" :readonly=\"true\" format=\"YYYY-MM-DD\" name=\"start-date\" :value.sync=\"sdate\" aria-describedby=\"errorStartDate\" _v-0879ddea=\"\"></datepicker>\n      <p v-if=\"formErrors.start_date\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Start Date</p>\n    </div>\n    <div class=\"form-group\" _v-0879ddea=\"\">\n      <label for=\"start-time\" _v-0879ddea=\"\">Start Time:</label>\n      <input id=\"start-time\" type=\"time\" v-model=\"newevent.start_time\" _v-0879ddea=\"\">\n    </div>\n    <fieldset class=\"form-group\" _v-0879ddea=\"\">\n      <label for=\"all-day\" _v-0879ddea=\"\">All Day?</label>\n      <label for=\"allDayYes\" class=\"radiobtns\" _v-0879ddea=\"\">Yes</label><input type=\"radio\" name=\"all-day\" id=\"allDayYes\" value=\"1\" v-model=\"newevent.all_day\" _v-0879ddea=\"\">\n      <label for=\"allDayNo\" class=\"radiobtns\" _v-0879ddea=\"\">No</label><input type=\"radio\" name=\"all-day\" id=\"allDayNo\" value=\"0\" v-model=\"newevent.all_day\" _v-0879ddea=\"\">\n    </fieldset>\n    <div class=\"form-group\" v-bind:class=\"[formErrors.end_date ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n      <label for=\"end-date\" _v-0879ddea=\"\">End Date:</label>\n      <datepicker id=\"end-date\" :readonly=\"true\" format=\"YYYY-MM-DD\" name=\"end-date\" :value.sync=\"edate\" _v-0879ddea=\"\"></datepicker>\n    </div>\n    <div class=\"form-group\" _v-0879ddea=\"\">\n      <label for=\"end-time\" _v-0879ddea=\"\">Start Time:</label>\n      <input id=\"end-time\" type=\"time\" v-model=\"newevent.end_time\" _v-0879ddea=\"\">\n    </div>\n    <fieldset class=\"form-group\" _v-0879ddea=\"\">\n      <label _v-0879ddea=\"\">No End Date:</label>\n      <label for=\"end-time-yes\" class=\"radiobtns\" _v-0879ddea=\"\">yes</label><input id=\"end-time-yes\" name=\"no-end-time\" type=\"radio\" value=\"1\" v-model=\"newevent.no_end_time\" _v-0879ddea=\"\">\n      <label for=\"end-time-no\" class=\"radiobtns\" _v-0879ddea=\"\">no</label><input id=\"end-time-no\" name=\"no-end-time\" type=\"radio\" value=\"0\" v-model=\"newevent.no_end_time\" _v-0879ddea=\"\">\n    </fieldset>\n  \n  <div class=\"form-group\" v-bind:class=\"[formErrors.categories ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n\n      <label for=\"categories\" _v-0879ddea=\"\">Categories:</label>\n      <select v-model=\"newevent.categories\" id=\"categories\" multiple=\"multiple\" class=\"multiselect\" _v-0879ddea=\"\">\n        <option v-for=\"category in categories\" :value=\"category.id\" _v-0879ddea=\"\">\n          {{category.category}}\n        </option>\n    </select>\n</div>\n<div class=\"form-group\" v-bind:class=\"[formErrors.contact_person ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n\n  <label _v-0879ddea=\"\">Contact Person\n    <input v-model=\"newevent.contact_person\" name=\"contact-person\" type=\"text\" _v-0879ddea=\"\">\n    <p v-if=\"formErrors.contact_person\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Contact Person!</p>\n  </label>\n\n</div>\n<div class=\"form-group\" v-bind:class=\"[formErrors.contact_phone? 'invalid-input' : '']\" _v-0879ddea=\"\">\n\n  <label _v-0879ddea=\"\">Contact Phone <em _v-0879ddea=\"\">(ex. 734.487.1849)</em>\n    <input v-model=\"newevent.contact_phone\" v-bind:class=\"[formErrors.contact_phone ? 'invalid-input' : '']\" name=\"contact-phone\" type=\"text\" _v-0879ddea=\"\">\n    <p v-if=\"formErrors.contact_phone\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Contact Phone!</p>\n  </label>\n</div>\n<div class=\"form-group\" v-bind:class=\"[formErrors.contact_email? 'invalid-input' : '']\" _v-0879ddea=\"\">\n  <label _v-0879ddea=\"\">Contact Email: <em _v-0879ddea=\"\">(ex. janedoe@emich.edu)</em>\n    <input v-model=\"newevent.contact_email\" v-bind:class=\"[formErrors.contact_email ? 'invalid-input' : '']\" name=\"contact-email\" type=\"text\" _v-0879ddea=\"\">\n    <p v-if=\"formErrors.contact_email\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Contact Email!</p>\n  </label>\n</div>\n\n    <div class=\"form-group\" _v-0879ddea=\"\">\n  <label _v-0879ddea=\"\">Contact Fax: <em _v-0879ddea=\"\">(ex. 734.487.1849)</em>\n    <input v-model=\"newevent.contact_fax\" v-bind:class=\"[formErrors.contact_fax ? 'invalid-input' : '']\" name=\"contact-fax\" type=\"text\" _v-0879ddea=\"\">\n  </label>\n\n</div>\n\n    <div class=\"form-group\" _v-0879ddea=\"\">\n  <label _v-0879ddea=\"\">Related Link: <em _v-0879ddea=\"\">(ex. http://www.emich.edu/calendar)</em>\n    <input v-model=\"newevent.related_link_1\" v-bind:class=\"[formErrors.related_link_1 ? 'invalid-input' : '']\" name=\"related-link-1\" type=\"text\" _v-0879ddea=\"\">\n  </label>\n  <label _v-0879ddea=\"\">Related Link: <em _v-0879ddea=\"\">(ex. http://www.emich.edu/calendar)</em>\n    <input v-model=\"newevent.related_link_2\" v-bind:class=\"[formErrors.related_link_2 ? 'invalid-input' : '']\" name=\"related-link-2\" type=\"text\" _v-0879ddea=\"\">\n  </label>\n  <label _v-0879ddea=\"\">Related Link: <em _v-0879ddea=\"\">(ex. http://www.emich.edu/calendar)</em>\n    <input v-model=\"newevent.related_link_1\" v-bind:class=\"[formErrors.related_link_1 ? 'invalid-input' : '']\" name=\"related-link-1\" type=\"text\" _v-0879ddea=\"\">\n  </label>\n</div>\n\n    <div class=\"form-group\" _v-0879ddea=\"\">\n  <label for=\"reg-deadline\" _v-0879ddea=\"\">Registration Deadline  </label>\n    <datepicker id=\"reg-deadline\" :readonly=\"true\" format=\"YYYY-MM-DD\" name=\"reg-deadline\" :value.sync=\"rdate\" _v-0879ddea=\"\"></datepicker>\n\n</div>\n\n  <div class=\"form-group\" _v-0879ddea=\"\">\n    <label _v-0879ddea=\"\">Event Cost\n      <input v-model=\"newevent.event_cost\" v-bind:class=\"[formErrors.event_cost ? 'invalid-input' : '']\" name=\"event-cost\" type=\"text\" _v-0879ddea=\"\">\n    </label>\n  </div>\n  <fieldset class=\"form-group\" _v-0879ddea=\"\">\n    <label _v-0879ddea=\"\">Free</label>\n    <label for=\"free-yes\" class=\"radiobtns\" _v-0879ddea=\"\">yes</label><input id=\"free-yes\" name=\"free-time\" type=\"radio\" value=\"1\" v-model=\"newevent.free\" _v-0879ddea=\"\">\n    <label for=\"free-no\" class=\"radiobtns\" _v-0879ddea=\"\">no</label><input id=\"free-no\" name=\"free-time\" type=\"radio\" value=\"0\" v-model=\"newevent.free\" _v-0879ddea=\"\">\n  </fieldset>\n\n\n  <div class=\"form-group\" _v-0879ddea=\"\">\n  <label _v-0879ddea=\"\">Tickets Available\n    <select v-model=\"newevent.tickets\" _v-0879ddea=\"\">\n      <option v-for=\"ticketoption in ticketoptions\" v-bind:value=\"ticketoption.value\" _v-0879ddea=\"\">\n       {{ ticketoption.text }}\n     </option>\n  </select>\n  </label>\n  <template v-if=\"newevent.tickets == 'online' || newevent.tickets == 'all'\">\n    <label _v-0879ddea=\"\">Link: <em _v-0879ddea=\"\">(ex. http://www.emich.edu/calendar)</em>\n      <input v-model=\"newevent.ticket_details_online\" v-bind:class=\"[formErrors.ticket_details_online ? 'invalid-input' : '']\" name=\"ticket-details-online\" type=\"text\" _v-0879ddea=\"\">\n    </label>\n  </template>\n  <template v-if=\"newevent.tickets == 'phone' || newevent.tickets == 'all'\">\n    <label _v-0879ddea=\"\">Tickets by Phone <em _v-0879ddea=\"\">(ex. 734.487.1849)</em>\n      <input v-model=\"newevent.ticket_details_phone\" v-bind:class=\"[formErrors.ticket_details_phone ? 'invalid-input' : '']\" name=\"ticket-details-phone\" type=\"text\" _v-0879ddea=\"\">\n    </label>\n  </template>\n  <template v-if=\"newevent.tickets == 'office' || newevent.tickets == 'all'\">\n    <label _v-0879ddea=\"\">Address\n      <input v-model=\"newevent.ticket_details_office\" v-bind:class=\"[formErrors.ticket_details_office ? 'invalid-input' : '']\" name=\"ticket-details-office\" type=\"text\" _v-0879ddea=\"\">\n    </label>\n  </template>\n  <template v-if=\"newevent.tickets == 'other'\">\n    <label _v-0879ddea=\"\">Other\n      <input v-model=\"newevent.ticket_details_other\" v-bind:class=\"[formErrors.ticket_details_other ? 'invalid-input' : '']\" name=\"ticket-details-other\" type=\"text\" _v-0879ddea=\"\">\n    </label>\n  </template>\n</div>\n\n\n  <div class=\"form-group\" _v-0879ddea=\"\">\n  <label _v-0879ddea=\"\">Participants\n    <select v-model=\"newevent.participants\" _v-0879ddea=\"\">\n      <option v-for=\"participant in participants\" v-bind:value=\"participant.value\" _v-0879ddea=\"\">\n       {{ participant.text }}\n     </option>\n  </select>\n  </label>\n</div>\n\n<div class=\"form-group\" _v-0879ddea=\"\">\n  <fieldset class=\"small-4 columns\" _v-0879ddea=\"\">\n    <label for=\"lbc-reviewed\" _v-0879ddea=\"\">LBC Approved: (pre-approval required)</label>\n    <label for=\"lbc-yes\" class=\"radiobtns\" _v-0879ddea=\"\">yes</label><input id=\"lbc-reviewed-yes\" name=\"lbc-reviewed\" type=\"radio\" value=\"1\" v-model=\"newevent.lbc_reviewed\" _v-0879ddea=\"\">\n    <label for=\"lbc-no\" class=\"radiobtns\" _v-0879ddea=\"\">no</label><input id=\"lbc-reviewed-no\" name=\"lbc-reviewed\" type=\"radio\" value=\"0\" v-model=\"newevent.lbc_reviewed\" _v-0879ddea=\"\">\n  </fieldset>\n</div>\n<div class=\"form-group\" v-bind:class=\"[formErrors.description ? 'invalid-input' : '']\" _v-0879ddea=\"\">\n\n  <label _v-0879ddea=\"\">Description</label>\n    <textarea v-model=\"newevent.description\" v-bind:class=\"[formErrors.description ? 'invalid-input' : '']\" name=\"description\" type=\"textarea\" _v-0879ddea=\"\"></textarea>\n    <p v-if=\"formErrors.description\" class=\"help-text invalid\" _v-0879ddea=\"\">Need a Description!</p>\n\n</div>\n\n    <div class=\"form-group\" _v-0879ddea=\"\">\n  <label _v-0879ddea=\"\">If your groups website has a calendar that is fed from this one, and you would like this event to show up on it, please select it from the list below:</label>\n  <select v-model=\"newevent.mini_calendar\" id=\"mini_calendar\" _v-0879ddea=\"\">\n    <option v-for=\"minicalendar in minicalendars\" :value=\"minicalendar.id\" _v-0879ddea=\"\">\n      {{minicalendar.calendar}}\n    </option>\n</select>\n</div>\n\n      <div class=\"form-group\" _v-0879ddea=\"\">\n    <button class=\"button\" type=\"submit\" _v-0879ddea=\"\">Publish</button>\n  </div>\n\n</form>\n"
...
},{"../vendor/datepicker.vue":13,"./vue-autocomplete.vue":11,"babel-runtime/core-js/json/stringify":1,"vue":8,"vue-hot-reload-api":6,"vueify/lib/insert-css":9}],11:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-78313973", module.exports)
  } else {
    hotAPI.update("_v-78313973", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/json/stringify":1,"vue":8,"vue-hot-reload-api":6,"vueify/lib/insert-css":9}],12:[function(require,module,exports){
'use strict';
...
},{"./components/EventForm.vue":10,"vue":8,"vue-form":5,"vue-resource":7}],13:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":8,"vue-hot-reload-api":6,"vueify/lib/insert-css":9}]},{},[12]);
