    ...
    methods: {
        ...
        submitForm: function submitForm(e) {
            ...
            this.$http[method](route, this.record).then(function (response) {
                ...
                _this3.response_record_id = response.data.newdata.record_id;
                _this3.response_stype = response.data.newdata.stype;
                if (_this3.newform) {
                    _this3.nowOnReload();
                } else {
                    _this3.onRefresh();
...
},{"./components/BoxTools.vue":9,"./components/StoryForm.vue":10,"./vuex/store":16,"moment":2,"vue":6,"vue-resource":5}],14:[function(require,module,exports){
'use strict';
